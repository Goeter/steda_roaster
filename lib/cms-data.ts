...
export const products: Product[] = [
  {
    ...
    specifications: [
      ...
      'Compact footprint for home roastery',
      'Food-grade stainless steel contact area',
      'Easy cleaning and maintenance',
      'Stable and even heat distribution',
      'User-friendly control interface',
      'Suitable for sample roasting',
  ...
  },
  {
    ...
    specifications: [
      'Industrial drum with stable airflow',
      'PLC control for precise roasting',
      'Integrated cooling tray with agitator',
      'Data logging capability',
      'Cyclone and chaff collector support',
      'Inspection port for bean checking',
      'Strong frame for continuous roasting',
      'Balanced heat retention system',
      'Easy cleaning access panels',
      'Suitable for small roastery production',
    ],
  },
  {
    id: 4,
    ...
    specifications: [
      'High-capacity production drum',
      'Industrial PLC control system',
      'Large cooling tray for fast discharge',
      'Cyclone included for cleaner roasting',
      'Consistent airflow management',
      'Heavy-duty frame construction',
      'Precise roast profile control',
      'Efficient heat retention design',
      'Emergency stop and safety features',
      'Built for intensive production schedules',
    ],
  },
];
